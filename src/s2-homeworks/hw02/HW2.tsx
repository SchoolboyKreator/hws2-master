...
export type FilterType = AffairPriorityType | 'all'
...
const defaultAffairs: AffairType[] = [ // need to fix any
    ...
    {_id: 6, name: 'memes', priority: 'middle'},
]

// pure helper functions
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[]  => { // need to fix any____
...
function HW2() {
    const [affairs, setAffairs] = useState<AffairType[]>(defaultAffairs) // need to fix any defaultAffairs
